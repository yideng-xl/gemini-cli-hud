 ...
 */
export function extractTaskProgress(text) {
 ...
 */
export function updateTaskProgress(current, responseText) {
 ...
 */
export function toolBasedProgress(toolCounts) {
 ...
 */
export function formatTaskModule(progress, lang = 'en') {
    if (progress.total === 0)
        return null;
    ...
    if (pct >= 1)
        color = '\x1b[32m'; // Green (all done)
    if (pct === 0)
        color = '\x1b[90m'; // Gray (none done)
